...
public class MissCheckWindows {
	...
	public MissCheckWindows(Mylabel label) {
...
//		reasonsexplanation.setBackground(nagativecColor);
	...
	private void initialize() {
		...
		JLabel notificationweidaka = new JLabel("未打卡说明（必填）：");
		notificationweidaka.setFont(new Font("微软雅黑", Font.BOLD, 12));
		...
		vacationreasons.setModel(new DefaultComboBoxModel(new String[] {"未打卡"}));
